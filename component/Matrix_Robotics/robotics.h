...
class Link {
 public:
  ...
  Matrixf<4, 4> T(float q);  // forward invKine
...
class Serial_Link {
 public:
  ...
  // inverse invKine, numerical solution(Newton method)
  ...
  // (Reserved function) inverse invKine, analytic solution(geometric method)
